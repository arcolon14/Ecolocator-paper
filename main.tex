...
\sbt{THis all reads nicely, but it does depart a bit from separation of Intro, Methods, Results. Consider moving parts around to the respective sections?}
...
we applied \ecolocator to predict the climate of origin of coastal \dfir
(\textit{Pseudotsuga menziesii} var. \textit{menziesii}),
...
Coastal \dfir spans steep gradients in temperature,
...
To minimize maladaptation in \dfir,
...
\dfir seed zones were formalized for U.S. Forest
...
makes \dfir a particularly powerful empirical system
...
348 unrelated coastal \dfir trees
...
Following model training and prediction, 
...
\sbt{This paragraph is probably too much narrative for results section.}
...
to climate via ClimateNA variables (\Cref{tab:supptable1}), indicating that \ecolocator
...
Because the \dfir genome is large and incompletely assembled, 
