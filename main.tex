...
Seed zones in particular offer something simulations cannot:
a standard, already used by managers, for deciding
whether a predicted climate is close enough to the true one.
