...
\begin{table}[ht]
  \centering
  \caption{Comparison of \ecolocator and Location+ClimateNA predictions across climate variables using the fixed-zone approach.} % ARC - I think you could add something here to differentiate it from Table 2. I added it to the header as an example.
  \label{tab:table1}
  \begin{tabular}{lcccc}
  \hline
...
\begin{table}[ht]
  \centering
  \caption{Comparison of \ecolocator and Location+ClimateNA predictions across climate variables using the focal point approach.} % Same here, adding to differentiate from Table 1
  \label{tab:table2}
  \begin{tabular}{lcccc}
  \hline
   & \multicolumn{2}{c}{\ecolocator} & \multicolumn{2}{c}{Location+ClimateNA} \\
...
% The mention of "the array" here comes a bit out of nowhere, so I am adding 
% some more context.
...
as much as on the model. % This sentence reads a bit weird to me, so I did some rewording. Please disregard as needed.
...
(we return to this under Strengths and limitations). % Maybe add a link to this?
