...
infalting false-positive rates in the Mantel tests 
used to distinguish them \citep{guillot_dismantling_2013,legendre_should_2015}.
...
and as ranges shift, managers need to know
...
and provenance tests are how we have learned most of what
we know about local adaptation, but they are slow and expensive,
...
Most of this work relies on genotype--environment association (GEA) methods,
which identify putatively adaptive loci
...
and ML methods can be effective at pulling patterns
...
and in crop genomics, deep learning models that take in weather, soil,
...
We pair the model with a feature attribution method, SHAP \citep{lundberg_shap_2017},
