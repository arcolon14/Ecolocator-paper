...
\citep{endler_geographic_1977, kawecki_conceptual_2004}.
...
the homogenizing effects of gene flow,
...
and Endler's cline theory \citep{endler_geographic_1977}---describe
...
to identify the conditions that yield strong performance,
then apply \ecolocator to an empirical dataset of coastal Douglas-fir
...
a member of the pine family with a lineage dating to the Paleocene \citep{hermann_genus_1985},
and with a natural range spanning extensive climatic
gradients across the North American Pacific coast from California
to British Columbia. While most populations are characterized by
...
quantitative phenotypes track climatic features such as winter cold
...
is central to (mal)adaptation \citep{stclair_1912_2020},
...
and longitude for each sample gave predicted geographic origins that showed a median error of 51.6km (see \Cref{fig:S6}).
...
to climate via ClimateNA variables (ref. \Cref{tab:supptable1}), indicating \ecolocator's ability to
