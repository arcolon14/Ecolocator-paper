...
The classic models of Wright \citep{wright_isolation_1943},
Levene \citep{levene_genetic_1953},
and Endler \citep{endler1977geographic}
...
and ML methods are good at pulling patterns
...
such that smaller values correspond to stronger local adaptation. Because dispersal, selection strength, and genetic architecture
...
all QTLs were clustered in a single window spanning 20\% 
of the chromosome, centered at its midpoint. In the second, 
QTLs were split across three windows, each spanning 10\% of 
the chromosome and centered at even intervals along its 
length (at the 25\%, 50\%, and 75\% positions). 
In the third, QTLs were split across five windows, each also spanning
10\% of the chromosome, 
centered at even intervals at approximately the 17\%, 33\%, 50\%, 67\%, 
and 83\% positions. 
