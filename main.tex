...
reducing long-range LD
and allowing clearer evaluation of locus-level feature attribution (\Cref{fig:ld-decay}).
...
Dispersal distance (\(\sigma_D\), also denoted as \(d\)) sets the spatial scale
...
following \citet{booker_wza_2024}. We additionally summarized
